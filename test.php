...
class UnitTest {
    ...
    public static function test(){
        ...
        // 下架
        $result['unshelve'] = array('params' => array('productId' => 'pXy6ujkx01pfqTaThrSDLd9G0PJ4', 'status' => CHWechatShopConst::PRODUCT_UNSHELVE),
            'result' => CHWechatShop::productStatus('pXy6ujkx01pfqTaThrSDLd9G0PJ4', CHWechatShopConst::PRODUCT_UNSHELVE));
        ...
        // 上传图片
        $result['uploadImage'] = array('params' => array('imagePath' => "../example.png"),
            'result' => CHWechatShop::uploadImage("../web/bundles/customweb/img/default/four_advantage_bg.png", "bg.png"));
        if ($result['uploadImage']['result']['errcode'] == 0) {
